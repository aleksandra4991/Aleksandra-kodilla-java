...
public class ShopService {
    ...
    public void addItem(long ordeId, long productId, double qty) {
        orders.stream()
    ...
    public boolean verifyOrder(Long orderId){
        ...
        while (orderIterator.hasNext()){
            ...
            Random generator = new Random();
            if(!theOrder.isVerfied()){
            theOrder.setVerfied(result && generator.nextBoolean());
            }
            return theOrder.isVerfied();
        }
        return false;
    }
